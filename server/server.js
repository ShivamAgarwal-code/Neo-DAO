...
const create_dao = require('./routes/dao/create-dao');
const submit_proposal = require('./routes/dao/submit-proposal');
const proposal_details = require('./routes/dao/proposal-details')
const list_daos = require('./routes/dao/list-daos');
const dao_details = require('./routes/dao/dao-details');
// const search_for_videos = require('./routes/search-for-videos');
// const search_youtube_api = require('./routes/search-youtube-api');

// -------------------- BEGIN: API ROUTES ------------

const get_cryptocurrency_asset_list = require('./routes/api/get-cryptocurrency-asset-list.js');
const get_cryptocurrency_price_api = require('./routes/api/price/get-cryptocurrency-price-api.js');
const get_config_vars_api = require('./routes/api/config/get-config-vars-api');
...
app.use('/', list_daos);
app.use('/', dao_details);
app.use('/', submit_proposal);
app.use('/', proposal_details);

// -------------------- BEGIN: API ROUTES ------------

app.use('/', get_cryptocurrency_asset_list);
app.use('/', get_cryptocurrency_price_api);
app.use('/', get_config_vars_api);
